...
public class Tiger implements Comparable<Tiger> {
	...
	private static final String[] NAMES_ARRAY = { "Tigra", "Leon", "Tog", "Took", "Much", "Greg", "Zevs",
			"Agr", "Don", "Din","Rex","Dex","Lex","Bim","Ciri","Fugi","Hagr","Wix","Fixy","Simba","Pury","Jery","Oxy","Mopsy","Yolo" };
	...
	public String toString() {
		return "Tiger " + "name: " + name + " NumberOfStripers: " + numberOfStripers + " Weight:"
