...
public class MobileWebTest {
    ...
    public void testIncorrectFBLogin() throws Exception {
        ...
        AppiumDriver driver = getAndroidDriver(new URL("http://0.0.0.0:4723/wd/hub"));
    ...
    private AppiumDriver getAppiumDriver(String platform, URL serverUrl) throws Exception {
        return platform.equals("iOS") ? getIOSDriver(serverUrl) : getAndroidDriver(serverUrl);
    }

    private AppiumDriver getIOSDriver(URL serverUrl) throws Exception {
